...
export async function POST(
  ...
  // Notify the seller (echo back). Mostly for the activity feed — the
  // dashboard polls the row directly and would see the change anyway.
  ...
  await admin.rpc("enqueue_notification", {
    ...
    p_body: title
      ? `Votre enchère pour « ${title} » est annulée. Vous pouvez la reprogrammer depuis votre tableau de bord.`
